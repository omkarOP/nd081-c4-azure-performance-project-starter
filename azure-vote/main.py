...
connection_string = 'InstrumentationKey=ab790300-fe6f-4a0c-b606-b2274f05932f;IngestionEndpoint=https://westus2-2.in.applicationinsights.azure.com/'
...
middleware = FlaskMiddleware(app, exporter=AzureExporter(connection_string=connection_string), sampler=ProbabilitySampler(1.0))
